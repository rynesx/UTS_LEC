...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6">
        ...
        <p class="text-gray-600 mb-4"><strong>Available Slots:</strong>
            <?php echo ($event['max_participants'] ?? 0) - ($event['current_participants'] ?? 0); ?> /
            <?php echo $event['max_participants'] ?? 0; ?></p>
        <p class="text-gray-800 mb-6">
            <?php echo nl2br(htmlspecialchars($event['description'] ?? 'No description available.')); ?></p>
